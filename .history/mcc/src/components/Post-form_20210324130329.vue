      ...
      <form @submit.prevent="postData" method="post">
        ...
        <div class="mb-3">
          ...
          <input
            name="departement"
            class="form-control"
            v-model.number="posts.Departement"
          />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input
            ...
            class="form-control"
            v-model.number="posts.dureeFormation"
          />
        </div>
        <div class="mb-3">
...
export default {
  ...
  methods: {
    postData() {
      axios
        .post("http://127.0.0.1:8000/api/formations", this.posts)
